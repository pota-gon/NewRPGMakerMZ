    ...
    class Window_EquipSkill extends Window_SkillList {
        ...
        setSkills() {
            ...
            if (item) {
                ...
                const skill_names = Potadra_metaData(item.meta['スキル追加']);
                skill_ids = traits.map(trait => trait["dataId"]).concat(Potadra_skillIds(skill_names));
