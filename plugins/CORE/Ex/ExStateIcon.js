/*:
@plugindesc
ステートアイコン参照制御文字 Ver1.0.0(2026/1/3)

@url https://raw.githubusercontent.com/pota-gon/RPGMakerMZ/refs/heads/main/plugins/BASIC/Ex/ExStateIcon.js
@target MZ
@author ポテトードラゴン
...
@help
## 概要
ステート名を参照する制御文字 \SSI を追加します

## 使い方
\SSI[毒] のようにステート名を記載すると  
[アイコン] のようにアイコンが表示されるようになります

同じステート名がある場合は、最初に見つけたステートアイコンが表示されます
*/
(() => {
    'use strict';
    ...
    Window_Base.prototype.convertEscapeCharacters = function(text) {
        ...
        tmp_text = tmp_text.replace(/\x1bSSI\[(.+?)\]/gi, (_, p1) =>
            "\x1bI[" + Potadra_nameSearch($dataStates, p1, 'iconIndex') + "]"
        );
        return tmp_text;
    };
})();
